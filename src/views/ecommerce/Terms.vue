	...
	<div class="wrapper py-20 px-40">
		<div class="mb-10">
			...
			<p>
				...
				communication between you and Papier Renei. Under no
				circumstances shall Papier Renei team be liable for any direct,
				...
				site, even if Papier Renei team or an authorized representative
				...
				thereof. Papier Renei will not be responsible for any outcome
		...
		<div class="mb-10">
			...
			<p class="mb-4">
				These Terms & Conditions are a contract between you and Papier
				Renei ("we," "our," or "us") grants you a revocable,
			...
			<ul class="list-disc space-y-4 pl-4">
				<li>
					<span class="font-bold">Cookie:</span> small amount of data
					generated by a website and saved by your web browser. It is
					used to identify your browser, provide analytics, and
					remember information about you such as your language
					preference or login information.
				</li>

				<li>
					<span class="font-bold">Company:</span> when this policy
					mentions “Company,” “we,” “us,” or “our,” it refers to
					Papier Renei, City of San Jose del Monte, Bulacan,
					Philippines, 3023 that is responsible for your information
					under this Privacy Policy.
				</li>

				<li>
					<span class="font-bold">Country:</span> where Papier Renei
					or the owners/founders of Papier Renei are based, in this
					case is Philippin
				</li>

				<li>
					<span class="font-bold">Device:</span> any internet
					connected device such as a phone, tablet, computer or any
					other device that can be used to visit Papier Renei and use
					the services.
				</li>

				<li>
					<span class="font-bold"> Personnel:</span> Every device
					connected to the Internet is assigned a number known as an
					Internet protocol (IP) address. These numbers are usually
					assigned in geographic blocks. An IP address can often be
					used to identify the location from which a device is
					connecting to the Internet.
				</li>

				<li>
					<span class="font-bold">Personal Data:</span> any
					information that directly, indirectly, or in connection with
					other information — including a personal identification
					number — allows for the identification or identifiability of
					a natural person.
				</li>

				<li>
					<span class="font-bold">Service:</span>refers to the service
					provided by Papier Renei as described in the relative terms
					(if available) and on this platform.
				</li>

				<li>
					<span class="font-bold">Third-party service:</span> refers
				...
				<li>
					<span class="font-bold">Website: </span>Papier Renei’s site,
					which can be accessed via this URL: papierenei@gmail.com.
				</li>

				<li>
					<span class="font-bold">You:</span> a person or entity that
					is registered with Papier Renei to use the Services.
				</li>
			</ul>
		</div>
		...
		<div class="mb-10">
			...
			<p class="mb-4">
				...
				providers of such material and are protected by Philippines and
		...
		<div class="mb-10">
			...
			<p class="mb-4">
				...
				PROPERTY RIGHTS. The term “dispute” means any dispute, action,
				or other controversy between you and us concerning the Services
				or this agreement, whether in contract, warranty, tort, statute,
		...
		<div class="mb-10">
			...
			<p class="mb-4">
				...
				for the product and/ or service listed at the incorrect price.
				We shall have the right to refuse or cancel any such order
		...
		<div class="mb-10">
			...
			<p class="mb-4">
				...
				Service from our offices in the Philippines. The Service is not
		...
		<div class="mb-10">
			...
			<ul class="list-disc space-y-4 pl-4">
				<li>Via Email: papierenei@gmail.com</li>

				<li>Via this Link: https://papierenei.com/contact</li>
			</ul>
		</div>
	</div>
</template>
