<template>
	<div class="mx-auto my-10 grid max-w-screen-2xl grid-cols-12">
		<div class="col-span-7">
			<form class="p-20" @submit.prevent="handleSumbit">
		...
		<div class="col-span-5 p-12 shadow-lg" v-if="cartStore.list.length > 0">
			<h3 class="col-span-full mb-2 text-xl font-semibold">
				Order Items
			</h3>
