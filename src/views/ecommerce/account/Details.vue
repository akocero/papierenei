<template>
	<div class="mx-4 max-w-[54rem] lg:mx-auto">
		<h2 class="my-6 font-nunito text-3xl font-black text-indigo-400">
			Account Information
		</h2>

		<div class="relative rounded bg-white px-8 py-6 pb-6 text-lg shadow-sm">
			<div v-if="!editInfo">
				<h3 class="mb-3 font-nunito font-bold text-indigo-400">
					Profile
				</h3>
				<button class="absolute right-6 top-6" @click="editInfo = true">
				...
				<div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
					...
					<div class="">
						<BaseInput
							...
							:errorField="
								EcomAuthStore.error?.errors?.firstName || null
							"
							placeholder="Ex. ABC"
							:required="false"
						/>
					...
					<div class="">
						<BaseInput
							...
							:error="EcomAuthStore.error"
							:errorField="
								EcomAuthStore.error?.errors?.lastName || null
							"
							placeholder="Ex. ABC"
							:required="false"
						/>
					...
					<div class="">
						<BaseInput
							...
							:error="EcomAuthStore.error"
							:errorField="
								EcomAuthStore.error?.errors?.barangay || null
							"
							placeholder="Ex. ABC"
							:required="false"
						/>
					...
					<div class="">
						<BaseInput
							...
							:error="EcomAuthStore.error"
							:errorField="
								EcomAuthStore.error?.errors?.province || null
							"
							placeholder="Ex. ABC"
							:required="false"
						/>
					...
					<div class="">
						<BaseInput
							...
							:error="EcomAuthStore.error"
							:errorField="
								EcomAuthStore.error?.errors?.streetAddress ||
								null
							"
							placeholder="Ex. ABC"
							:required="false"
