<template>
	<div class="card">
		<div class="mb-4 flex items-baseline">
			...
			<BaseButtonVue text="Add Macbook" _class="mr-2 ml-auto" />
		</div>
	...
	<BaseButtonVue text="Add New" color="yellow" /> -->
		...
		<div class="overflow-x-auto relative">
			<table class="w-full text-sm text-left">
				<thead
					class="text-md border border-primary-100 text-primary-900"
				>
					<tr>
						<th scope="col" class="py-4 bg-primary-50 px-4">
							Product name
						</th>
						<th scope="col" class="py-4 bg-primary-50 px-4">
							Color
				...
				<tbody>
					<tr v-for="item in [1, 2, 3, 4]" class="bg-white border">
